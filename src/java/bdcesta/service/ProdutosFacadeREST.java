...
public class ProdutosFacadeREST extends AbstractFacade<Produtos> {
    ...
    public void create(Produtos entity) {
        super.create(entity);
    }
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Integer id, Produtos entity) {
        super.edit(entity);
    }
    ...
    public Produtos find(@PathParam("id") Integer id) {
